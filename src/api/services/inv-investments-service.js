...
const ztsymbols = require('../models/mongodb/ztsymbols');
 ...
 //SERVICIO DE OPERACIONES DE INVERSIÓN Y SIMULACIÓN


// Consulta el historial de precios de un símbolo específico
async function GetAllPricesHistory(req) {
  try {
    const symbol = req.req.query?.symbol || 'AAPL';
    // Nota: Cambiar a FinancialModelingPrep si es necesario
    ...
    // Formatea los datos para la entidad CDS
...
// Calcula el stop-loss dinámico para una operación
...
// Parsea los parámetros de especificaciones para estrategias
...
// Simulación de estrategia MA Crossover
...
// Simulación de estrategia Supertrend
...
// Simulación de estrategia Momentum
...
// Simulación de estrategia Reversión Simple
...
// Consulta todas las estrategias de inversión disponibles
...
// Consulta todos los símbolos disponibles
const GetAllSymbols = async () => {

};
  
  // Consulta todas las empresas disponibles
